...
class ErrorClass:
    ...
    company_type_incorrect = {STATUS_CODE: 2110023, MESSAGE: "Enter correct company type"}
    ...
    user_not_found = {STATUS_CODE: 2110029, MESSAGE: "User not exist"}
    refresh_token_not_given = {STATUS_CODE: 2110030, MESSAGE: "Refresh token Mandatory"}
    invalid_refresh_token = {STATUS_CODE: 2110031, MESSAGE: "Refresh token provided is invalid"}
